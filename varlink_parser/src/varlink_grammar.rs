        ...
        let __choice_res = {
            ...
            let res = {
                ...
                match if __input.len() > __pos {
                    ...
                    match __ch { ' ' | '\t' | '\u{a0}' | '\u{feff}' | '\u{1680}' | '\u{180e}' | '\u{2000}' ... '\u{200a}' | '\u{202f}' | '\u{205f}' | '\u{3000}' => Matched ( __next , ( ) ) , _ => __state . mark_failure ( __pos , "[ \t\u{a0}\u{feff}\u{1680}\u{180e}\u{2000}-\u{200a}\u{202f}\u{205f}\u{3000}]" ) , }
                } else {
                    __state . mark_failure ( __pos , "[ \t\u{a0}\u{feff}\u{1680}\u{180e}\u{2000}-\u{200a}\u{202f}\u{205f}\u{3000}]" )
                } {
                ...
                match {
                    ...
                    match __seq_res {
                        Matched(__pos, _) => {
                            ...
                            match __seq_res {
                                Matched(__pos, _) => match __parse_eol_r(__input, __state, __pos) {
                            ...
                            match __seq_res {
                                Matched(__pos, _) => {
                                    if __input.len() > __pos {
                                        ...
                                        __state.mark_failure(__pos, "[A-Za-z0-9]")
                                    }
                                }
                                Failed => Failed,
                            }
    ...
    #![allow(non_snake_case, unused)]
    {
        ...
        match {
            let __seq_res = if __input.len() > __pos {
                ...
                __state.mark_failure(__pos, "[A-Z]")
            };
            match __seq_res {
                Matched(__pos, _) => {
                    let mut __repeat_pos = __pos;
...
fn __parse_interface_name<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<&'input str> {
                                            ...
                                            Matched(__pos, _) => {
                                                if __input.len() > __pos {
                                                    ...
                                                    match __ch {
                                                        ...
                                                        _ => {
                                                            __state.mark_failure(__pos, "[a-z0-9]")
                                                        }
                                                    }
                                                } else {
                                                    __state.mark_failure(__pos, "[a-z0-9]")
                                                                    ...
                                                                    let __seq_res = {
                                                                        ...
                                                                        loop {
                                                                            ...
                                                                            let __step_res =
                                                                                ...
                                                                                {
                                                                                    let ( __ch , __next ) = char_range_at ( __input , __pos ) ;
                                                                                    match __ch { '-' => Matched ( __next , ( ) ) , _ => __state . mark_failure ( __pos , "[-]" ) , }
                                                                                } else {
                                                                                    __state . mark_failure ( __pos , "[-]" )
                                                                                };
                                                                            match __step_res {
                                                                    ...
                                                                    match __seq_res {
                                                                        Matched(__pos, _) => {
                                                                            if __input.len() > __pos
                                                                            {
                                                                                ...
                                                                                match __ch { 'a' ... 'z' | '0' ... '9' => Matched ( __next , ( ) ) , _ => __state . mark_failure ( __pos , "[a-z0-9]" ) , }
                                                                            } else {
                                                                                __state
                                                                                    .mark_failure(
                                                                                        __pos,
...
fn __parse_dict<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<()> {
    #![allow(non_snake_case, unused)]
    slice_eq(__input, __state, __pos, "[string]")
}

fn __parse_option<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<()> {
...
fn __parse_btype<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<VTypeExt<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __choice_res = {
                ...
                match __choice_res {
                    ...
                    Failed => {
                        let __choice_res = {
                            ...
                            match __seq_res {
                                Matched(__pos, _) => {
                                    Matched(__pos, { VTypeExt::Plain(VType::Float) })
                                }
                                Failed => Failed,
                            }
                        };
                        match __choice_res {
                            ...
                            Failed => {
                                let __choice_res = {
                                    ...
                                    match __seq_res {
                                        Matched(__pos, _) => {
                                            Matched(__pos, { VTypeExt::Plain(VType::String) })
                                        }
                                        Failed => Failed,
                                    }
                                };
                                match __choice_res {
                                    ...
                                    Failed => {
                                        let __choice_res = {
                                            let __seq_res =
                                                slice_eq(__input, __state, __pos, "object");
                                            match __seq_res {
                                                Matched(__pos, _) => Matched(__pos, {
                                                    VTypeExt::Plain(VType::Object)
                                                }),
                                                Failed => Failed,
                                            }
                                        };
                                                ...
                                                let __choice_res = {
                                                    ...
                                                    match __seq_res {
                                                        Matched(__pos, t) => Matched(__pos, {
                                                            VTypeExt::Plain(VType::Typename(t))
                                                        }),
                                                        Failed => Failed,
                                                    }
                                                };
                ...
                let __choice_res = {
                    ...
                    match __seq_res {
                        Matched(__pos, a) => {
                            ...
                            match __seq_res {
                                Matched(__pos, v) => {
                                    Matched(__pos, { VTypeExt::Array(Box::new(v)) })
                                }
                                Failed => Failed,
                            }
                        }
                        ...
                        let __choice_res = {
                            ...
                            match __seq_res {
                                Matched(__pos, a) => {
                                    ...
                                    match __seq_res {
                                        Matched(__pos, v) => {
                                            Matched(__pos, { VTypeExt::Dict(Box::new(v)) })
                                        }
                                        Failed => Failed,
                                    }
                                }
                                ...
                                let __choice_res = {
                                    ...
                                    match __seq_res {
                                        Matched(__pos, o) => {
                                            let __seq_res = __parse_btype(__input, __state, __pos);
                                            match __seq_res {
                                                Matched(__pos, v) => Matched(__pos, {
                                                    VTypeExt::Option(Box::new(v))
                                                }),
                                                Failed => Failed,
                                            }
                                        }
                                    ...
                                    Failed => {
                                        let __choice_res = {
                                            ...
                                            match __seq_res {
                                                Matched(__pos, o) => {
                                                    let __seq_res =
                                                        __parse_array(__input, __state, __pos);
                                                    match __seq_res {
                                                        Matched(__pos, a) => {
                                                            let __seq_res = __parse_type(
                                                                __input, __state, __pos,
                                                            );
                                                            match __seq_res {
                                                                Matched(__pos, v) => {
                                                                    Matched(__pos, {
                                                                        VTypeExt::Option(Box::new(
                                                                            VTypeExt::Array(
                                                                                Box::new(v),
                                                                            ),
                                                                        ))
                                        ...
                                        match __choice_res {
                                            ...
                                            Failed => {
                                                let __seq_res =
                                                    __parse_option(__input, __state, __pos);
                                                match __seq_res {
                                                    Matched(__pos, o) => {
                                                        let __seq_res =
                                                            __parse_dict(__input, __state, __pos);
                                                        match __seq_res {
                                                            Matched(__pos, a) => {
                                                                let __seq_res = __parse_type(
                                                                    __input, __state, __pos,
...
fn __parse_object_field<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<Argument<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            let mut __repeat_pos = __pos;
                                    ...
                                    Matched(__pos, _) => {
                                        let __seq_res = {
                                            ...
                                            loop {
                                                let __pos = __repeat_pos;
                                                let __step_res =
                                                    match __parse__(__input, __state, __pos) {
                                                        Matched(pos, _) => Matched(pos, ()),
                                                        Failed => Failed,
                                                    };
                                                match __step_res {
                                        ...
                                        match __seq_res {
                                            Matched(__pos, _) => {
                                                let __seq_res =
                                                    __parse_type(__input, __state, __pos);
                                                match __seq_res {
                                                    Matched(__pos, v) => Matched(__pos, {
                                                        Argument { name: n, vtype: v }
                                                    }),
                                                    Failed => Failed,
                                                }
                                            }
...
fn __parse_vstruct<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<VStruct<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = slice_eq(__input, __state, __pos, "(");
        match __seq_res {
...
fn __parse_venum<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<VEnum<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = slice_eq(__input, __state, __pos, "(");
        match __seq_res {
...
fn __parse_vtypedef<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<Typedef<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __choice_res = {
            let __seq_res = {
                                    ...
                                    match __seq_res {
                                        Matched(__pos, n) => {
                                            ...
                                            match __seq_res {
                                                Matched(__pos, _) => {
                                                    let __seq_res =
                                                        __parse_vstruct(__input, __state, __pos);
                                                    match __seq_res {
                                                        Matched(__pos, v) => Matched(__pos, {
                                                            Typedef {
                                                                name: n,
                                                                doc: trim_doc(d),
                                                                elt: VStructOrEnum::VStruct(
                                                                    Box::new(v),
                                                                ),
                                                            }
                                                        }),
                                        ...
                                        match __seq_res {
                                            Matched(__pos, n) => {
                                                let __seq_res = {
                                                    ...
                                                    loop {
                                                        let __pos = __repeat_pos;
                                                        let __step_res = match __parse__(
                                                            __input, __state, __pos,
                                                        ) {
                                                            Matched(pos, _) => Matched(pos, ()),
                                                            Failed => Failed,
                                                ...
                                                match __seq_res {
                                                    Matched(__pos, _) => {
                                                        let __seq_res =
                                                            __parse_venum(__input, __state, __pos);
                                                        match __seq_res {
                                                            Matched(__pos, v) => Matched(__pos, {
                                                                Typedef {
                                                                    name: n,
                                                                    doc: trim_doc(d),
                                                                    elt: VStructOrEnum::VEnum(
                                                                        Box::new(v),
                                                                    ),
                                                                }
                                                            }),
...
fn __parse_error<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<VError<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            let str_start = __pos;
...
fn __parse_method<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<Method<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            let str_start = __pos;
...
fn __parse_member<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<MethodOrTypedefOrError<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __choice_res = {
            ...
            Failed => {
                ...
                match __choice_res {
                    ...
                    Failed => {
                        ...
                        match __seq_res {
                            Matched(__pos, e) => {
                                Matched(__pos, { MethodOrTypedefOrError::Error(e) })
                            }
                            Failed => Failed,
                        }
                    }
...
fn __parse_VInterface<'input>(
    __input: &'input str,
    __state: &mut ParseState<'input>,
    __pos: usize,
) -> RuleResult<Interface<'input>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            let str_start = __pos;
                                            ...
                                            Matched(__pos, _) => {
                                                let __seq_res = {
                                                    ...
                                                    loop {
                                                        let __pos = __repeat_pos;
                                                        let __pos = if __repeat_value.len() > 0 {
                                                            let __sep_res = match __parse_eol(
                                                                __input, __state, __pos,
                                                            ) {
                                                                Matched(pos, _) => Matched(pos, ()),
                                                                Failed => Failed,
                                                        ...
                                                        let __step_res =
                                                            __parse_member(__input, __state, __pos);
                                                        match __step_res {
                                                            Matched(__newpos, __value) => {
                                                                __repeat_pos = __newpos;
                                                                __repeat_value.push(__value);
